...
contract ProofVerifier {
    ...
    /// @param proofsBlob is an rlp encoded array of the account proof and the storage proof. Each of these is the rlp encoded nibbles that is the corresponding proof. This is normally returned by eth_getProof.
